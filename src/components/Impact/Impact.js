...
const dietQuestion = () => {
  return (
    <form>
      <label htmlFor="diet">What percentage of your diet do you think is provided by bees?</label>
      <input type="text" id="died" placeholder="Enter a number between 1 and 100"/>
